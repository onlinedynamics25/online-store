...
const FeaturedProducts = () => {
  ...
  const handleAccount = () => {
    ...
    else promptAuth("login", "/dashboard");
  };
        ...
        <div className="container">
          ...
          <div className="md:hidden mt-8 text-center">
            <button
              ...
              className="hidden md:flex items-center gap-2 text-sm font-medium text-foreground hover:text-secondary transition-colors font-body bg-transparent border-none cursor-pointer"
            >
              View All <ArrowRight className="h-4 w-4" />
            </button>
          </div>
